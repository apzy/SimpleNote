...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FramelessWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_FramelessWidget_t qt_meta_stringdata_FramelessWidget = {
    {
QT_MOC_LITERAL(0, 15) // "FramelessWidget"
...
const QMetaObject FramelessWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_FramelessWidget.offsetsAndSize,
    qt_meta_data_FramelessWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_FramelessWidget_t
